...
export async function POST(request: Request) {
  try {
    ...
    const prompt = `Sen profesyonel bir diyetisyensin. Kullanıcının profili şu şekildedir:
    - Vücut Kitle Endeksi (VKE) Durumu: ${vke || "Normal"}
    - Günlük Alınan Kalori: ${kalori || 0} kcal
    - Yapılan Günlük Kardiyo: ${kardiyo || 0} dakika

    Bu bilgilere dayanarak kullanıcıya özel, sabah, öğle ve akşam öğünlerini içeren örnek ve sağlıklı 1 günlük kişiselleştirilmiş diyet listesi hazırla. Madde işaretleri kullanarak kısa ve anlaşılır bir şekilde yaz.`;
